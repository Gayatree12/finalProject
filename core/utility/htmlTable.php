<?php
  ...
  class htmlTable {
    public static function genarateTableFromMultiArray($array) {
        ...
        $tableGen = '<table border="2"cellpadding="8">';
        $tableGen .= '<tr>';
        //gets the first element of the array to extract the field headings for the table
    ...
    public static function generateTableFromOneRecord($innerArray) {
        $tableGen = '<table border="2" cellpadding="8"><tr>';
        $tableGen .= '<tr>';
